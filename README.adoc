...
== ¿Como jugarlo?
  ...
  *Segundo clonar el repositorio y abrirlo desde nuestro IDE, por ejemplo Eclipse.
  *Tercer nos pocisionamos sobre el archivo "src/juego/Juego.java" y ejecutamos el código. 
